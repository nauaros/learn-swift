...
func isInRange3(customer: Location) -> Bool {
    for pizzaRange in pizzaJoints {
        let difference = sqrt(pow((pizzaRange.center.latitude - customer.latitude), 2) +
...
let customer = Location(latitude: 44.9850, longitude: -93.2750)

print(isInRange3(customer)) // Pizza time!


// Now use a method on DeliveryRange!
